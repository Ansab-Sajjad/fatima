...
export function Credentialing_Payor() {
  ...
  it("E-3 Select Area of Expertise.", () => {
    cy.get(
      "#areaOfExpertise > .custom-select__control > .custom-select__value-container"
    )
      .click({ force: true })
      .wait(2000);
  ...
  it("E-5 Select Credentialing Type.", () => {
    cy.get(
      "#credentialingType > .custom-select__control > .custom-select__value-container"
    )
      .click({ force: true })
      .wait(2000);
    cy.get(".custom-select__option:eq(0)").click({ force: true }).wait(3000);
  ...
  it("E-7 Select Credentialing Coordinaor.", () => {
    cy.get(
      "#credentialingCoordinator > .custom-select__control > .custom-select__value-container > .custom-select__input-container"
    )
      .click({ force: true })
      .wait(2000);
  ...
  it("E-10 Select Date of Addiitonal Inquiries.", () => {
    cy.get("#dateOfAdditionalInquiries")
      .click({ force: true })
      .wait(2000)
      .type("12/10/2023")
      .type("{enter}")
  ...
  it("E-11 Select Application Sent For Contractor Review Signature On.", () => {
    cy.get("#applicationSentForContractorReviewSignatureOn")
      .click({ force: true })
      .wait(2000)
      .type("12/05/2023")
      .type("{enter}")
  ...
  it("E-12 Select Application Signed And Returned On", () => {
    cy.get("#applicationSignedAndReturnedOn")
      .click({ force: true })
      .wait(2000)
      .type("12/05/2023")
      .type("{enter}")
  ...
  it("E-13 Select paperwork Submitted To Facility On", () => {
    cy.get("#paperworkSubmittedToFacilityOn")
      .click({ force: true })
      .wait(2000)
      .type("12/05/2023")
      .type("{enter}")
  ...
  it("E-14 Select Facility Approval", () => {
    cy.get(
      "#facilityApproval > .custom-select__control > .custom-select__value-container > .custom-select__input-container"
    )
      .click({ force: true })
      .wait(2000);
  ...
  it("E-16 Add Provider Notes", () => {
    cy.get(
      ":nth-child(17) > .form-group > :nth-child(2) > .form-controls > textarea"
    )
      .click({ force: true })
      .wait(2000)
      .type(
  ...
  it("E-17 Add Facility Notes", () => {
    cy.get(
      ":nth-child(18) > .form-group > :nth-child(2) > .form-controls > textarea"
    )
      .click({ force: true })
      .wait(2000)
      .type(
  ...
  it("E-18 Select payor Documents Sent For Provider Signatures On", () => {
    cy.get("#payorDocumentsSentForProviderSignaturesOn")
      .click({ force: true })
      .wait(2000)
      .type("12/05/2023")
      .type("{enter}")
  ...
  it("E-19 Select payor Paperwork Submitted To Facility On", () => {
    cy.get("#payorPaperworkSubmittedToFacilityOn")
      .click({ force: true })
      .wait(2000)
      .type("12/15/2023")
      .type("{enter}")
  ...
  it("E-20 Select payor Enrollment Submitted To Payors On", () => {
    cy.get("#payorEnrollmentSubmittedToPayorsOn")
      .click({ force: true })
      .wait(2000)
      .type("12/25/2023")
      .type("{enter}")
  ...
  it("E-22 Select Payor Enrollment Approval Status", () => {
    cy.get(
      "#payorEnrollmentApprovalStatus > .custom-select__control > .custom-select__value-container"
    )
      .click({ force: true })
      .wait(2000);
    cy.get(".custom-select__option:eq(0)").click({ force: true }).wait(3000);
  ...
  it("E-23 Select payor Enrollment Status Date", () => {
    cy.get("#payorEnrollmentApprovalDate")
      .click({ force: true })
      .wait(2000)
      .type("12/30/2023")
      .type("{enter}")
  ...
  it("E-24 Add Payor Staff Notes on Payor Enrollment", () => {
    cy.get(
      ":nth-child(25) > .form-group > :nth-child(2) > .form-controls > textarea"
    )
      .click({ force: true })
      .wait(2000)
      .type(
  ...
  it("E-25 Add Payor Facility Notes on Payor Enrollment", () => {
    cy.get(
      ":nth-child(26) > .form-group > :nth-child(2) > .form-controls > textarea"
    )
      .click({ force: true })
      .wait(2000)
      .type(
  ...
  it("E-26 Add General Notes Payor Enrollment", () => {
    cy.get(
      ":nth-child(27) > .form-group > :nth-child(2) > .form-controls > textarea"
    )
      .click({ force: true })
      .wait(2000)
      .type(
  ...
  it("E-27 Select Payor Enrollment Assigned To", () => {
    cy.get(
      "#assignedTo > .custom-select__control > .custom-select__value-container > .custom-select__input-container"
    )
      .click({ force: true })
      .wait(2000);
    cy.get(".custom-select__option:eq(0)").click({ force: true }).wait(3000);
  ...
  function selectDropdown(selector, optionIndex) {
    cy.get(
      `${selector} > .custom-select__control > .custom-select__value-container > .custom-select__input-container`
    )
      .click({ force: true })
      .wait(2000);
    cy.get(`.custom-select__option:eq(${optionIndex})`)
      .click({ force: true })
      .wait(3000);
  }
  ...
  function updateCombination(
    ...
    // Example:
    selectDropdown(providerSelector, 17);
    selectDropdown(expertiseSelector, 3);
    selectDropdown(facilitySelector, 15);
  }
...
export function Credentialing_Payor_Update() {
  ...
  it("E-4 Check disabled fields on edit page", () => {
    ...
    disabledFields.forEach((field) => {
      cy.get(field)
        .should("exist")
        .should("have.class", "custom-select--is-disabled");
    });
  });
  ...
  it("E-8 Select Payor Enrollment Approval Status.", () => {
    cy.get(
      "#payorEnrollmentApprovalStatus > .custom-select__control > .custom-select__value-container > .custom-select__input-container"
    ).click({ force: true });
    cy.get(".custom-select__option:eq(1)").click({ force: true }).wait(3000);
  });
    ...
    cy.get(".Toastify__toast-body > :nth-child(2)")
      ...
      .then((text) => {
        ...
        expect(text.trim()).to.equal(
          "Credentialing and Payor Enrollment status has been updated successfully"
        );
      });
  });
}

//================================================ View Credenitialing Payor ================================================//
...
export function Archived_Credentialing_Payor() {
  ...
  it("E-2 Click on 3 dots.", () => {
    cy.get(
      ":nth-child(2) > .stickycolumn > .table-dropdown > #dropdown-basic > .icon-Vertical-Dots"
    )
      .click({ force: true })
      .wait(2000);
  });
  ...
  it("E-3 Click on Archived link", () => {
    ...
    cy.contains("Your record has been archived successfully").should(
      "be.visible"
    );
  });
  ...
  it("should have Reinstate actions for each Record", () => {
    cy.get(
      ":nth-child(1) > .stickycolumn > .table-dropdown > #dropdown-basic > .icon-Vertical-Dots"
    )
      .click({ force: true })
      .wait(2000);
    cy.contains("Reinstate").should("exist").click({ force: true });
    cy.wait(3000);
  });

  it("Click on Reinstate Button From Confirmation Model", () => {
    cy.get('[data-testid="confirm-confirmation"]')
      .click({ force: true })
      .wait(2000);
  });

  it("Verify Reinsate Record Success Messgae", () => {
    cy.get(".Toastify__toast-body > :nth-child(2)")
      .click({ force: true })
      .wait(2000);
  });
